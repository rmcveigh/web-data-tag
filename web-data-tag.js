...
function dataTagSendData(data, gtmServerDomain, requestPath, dataLayerEventName, dataLayerVariableName, ucLocalStorageKey) {
  ...
  if (ucLocalStorageKey === 'ucData') {
    ...
    if (storedData) {
      ...
      try {
        ...
        consentServices = parsedData.consent.services || {};
        okToSend = Object.keys(consentServices).length > 0;
      } catch (error) {
        // Handle the case where data is not valid JSON
        console.error('Error parsing JSON:', error);
      }
    }
    if (Object.keys(consentServices).length > 0) {
      for (const service in consentServices) {
        let consent = consentServices[service].consent || false;
        let name = consentServices[service].name || '';
        if ((name === 'Google Analytics' || name === '') && !consent) {
          okToSend = false;
          break;
        }
      }
    }
  } else if (ucLocalStorageKey === 'uc_settings' && dataLayer && dataLayer.length > 0) {
  ...
  if (!okToSend) {
    ...
    console.log('User has consented to Google Analytics');
  }
}
...
function dataTagMD5(inputString) {
  ...
  var i, x = sb(inputString), a = 1732584193, b = -271733879, c = -1732584194,
    d = 271733878, olda, oldb, oldc, oldd;
...
!function (t, r) {(t = 'undefined' != typeof globalThis ? globalThis : t || self).dataTagJsSHA = r();}(this, (function () {
  'use strict';
  var t = function (r, n) {
    return (t = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function (t, r) {t.__proto__ = r;} || function (t, r) {
      for (var n in r) {
  ...
  function n(t, r, n, i) {
    ...
    for (e = 0; e < t.length; e += 1) {
      o = (u = e + f) >>> 2, s.length <= o && s.push(0), s[o] |= t[e] << 8 * (h + i * (u % 4));
    }
  ...
  function i(t, i, e) {
    ...
    switch (t) {
          ...
          return function (t, r, n, i, e) {
            ...
            if ('UTF8' === r) {
              ...
              for (c = -1 === e ? 2 : 0, w = 'UTF16LE' === r && 1 !== e || 'UTF16LE' !== r && 1 === e, s = 0; s < t.length; s += 1) {
                for (o = t.charCodeAt(s), !0 === w && (o = (f = 255 & o) << 8 | o >>> 8), h = (a = v + A) >>> 2; E.length <= h;) {
                  E.push(0);
                }
                E[h] |= o << 8 * (c + e * (a % 4)), v += 2;
              }
      ...
      case'B64':
        return function (t, n, i) {
          return function (t, n, i, e) {
            var o, u, s, f, h, a, c = 0, w = n || [0], v = (i = i || 0) >>> 3,
              E = -1 === e ? 3 : 0, A = t.indexOf('=');
      ...
      case'ARRAYBUFFER':
        ...
        return function (t, r, i) {return function (t, r, i, e) {return n(new Uint8Array(t), r, i, e);}(t, r, i, e);};
      case'UINT8ARRAY':
        try {new Uint8Array(0);} catch (t) {throw new Error('UINT8ARRAY not supported by this environment');}
        return function (t, r, i) {return n(t, r, i, e);};
      default:
  ...
  function e(t, n, i, e) {
    switch (t) {
      case'HEX':
        return function (t) {
          return function (t, r, n, i) {
            ...
            for (e = 0; e < s; e += 1) {
              o = t[e >>> 2] >>> 8 * (f + n * (e % 4)), u += '0123456789abcdef'.charAt(o >>> 4 & 15) + '0123456789abcdef'.charAt(15 & o);
            }
      ...
      case'B64':
        return function (t) {
          return function (t, n, i, e) {
            ...
            for (o = 0; o < c; o += 3) {
              for (f = o + 1 < c ? t[o + 1 >>> 2] : 0, h = o + 2 < c ? t[o + 2 >>> 2] : 0, s = (t[o >>> 2] >>> 8 * (w + i * (o % 4)) & 255) << 16 | (f >>> 8 * (w + i * ((o + 1) % 4)) & 255) << 8 | h >>> 8 * (w + i * ((o + 2) % 4)) & 255, u = 0; u < 4; u += 1) {
      ...
      case'BYTES':
        return function (t) {
          return function (t, r, n) {
            ...
            for (i = 0; i < u; i += 1) {
              e = t[i >>> 2] >>> 8 * (s + n * (i % 4)) & 255, o += String.fromCharCode(e);
            }
            return o;
          }(t, n, i);
        };
      case'ARRAYBUFFER':
        ...
        return function (t) {
          return function (t, r, n) {
            var i, e = r / 8, o = new ArrayBuffer(e), u = new Uint8Array(o),
              s = -1 === n ? 3 : 0;
            for (i = 0; i < e; i += 1) {
  ...
  function f(t) {
    var r = { outputUpper: !1, b64Pad: '=', outputLen: -1 }, n = t || {},
  ...
  function h(t, r) {return t >>> r | t << 32 - r;}

  function a(t, r) {return t >>> r;}

  function c(t, r, n) {return t & r ^ ~t & n;}

  function w(t, r, n) {return t & r ^ t & n ^ r & n;}

  function v(t) {return h(t, 2) ^ h(t, 13) ^ h(t, 22);}
  ...
  function d(t) {return h(t, 7) ^ h(t, 18) ^ a(t, 3);}

  function l(t) {return h(t, 6) ^ h(t, 11) ^ h(t, 25);}

  function R(t) {return 'SHA-224' == t ? u.slice() : s.slice();}

  function y(t, r) {
    var n, i, e, u, s, f, R, y, U, b, T, m, F = [];
    for (n = r[0], i = r[1], e = r[2], u = r[3], s = r[4], f = r[5], R = r[6], y = r[7], T = 0; T < 64; T += 1) {
      F[T] = T < 16 ? t[T] : A(h(m = F[T - 2], 17) ^ h(m, 19) ^ a(m, 10), F[T - 7], d(F[T - 15]), F[T - 16]), U = p(y, l(s), c(s, f, R), o[T], F[T]), b = E(v(n), w(n, i, e)), y = R, R = f, f = s, s = E(u, U), u = e, e = i, i = n, n = E(U, b);
    }
  ...
  return function (r) {
    function n(t, n, e) {
      ...
      var u = e || {};
      return (o = r.call(this, t, n, e) || this).t = o.i, o.o = !0, o.u = -1, o.s = i(o.h, o.v, o.u), o.A = y, o.p = function (t) {return t.slice();}, o.l = R, o.R = function (r, n, i, e) {
        return function (t, r, n, i, e) {
          for (var o, u = 15 + (r + 65 >>> 9 << 4), s = r + n; t.length <= u;) {
            t.push(0);
          }
          for (t[r >>> 5] |= 128 << 24 - r % 32, t[u] = 4294967295 & s, t[u - 1] = s / 4294967296 | 0, o = 0; o < t.length; o += 16) {
    ...
    function t(t, r, n) {
      var i = n || {};
      if (this.h = r, this.v = i.encoding || 'UTF8', this.numRounds = i.numRounds || 1, isNaN(this.numRounds) || this.numRounds !== parseInt(this.numRounds, 10) || 1 > this.numRounds) {
    ...
    return t.prototype.update = function (t) {
      var r, n = 0, i = this.T >>> 5, e = this.s(t, this.Y, this.H),
        o = e.binLen, u = e.value, s = o >>> 5;
      for (r = 0; r < s; r += i) {
        n + this.T <= o && (this.U = this.A(u.slice(r, r + i), this.U), n += this.T);
      }
      this.I += n, this.Y = u.slice(n >>> 5), this.H = o % this.T, this.S = !0;
    }, t.prototype.getHash = function (t, r) {
      var n, i, o = this.m, u = f(r);
      if (this.F) {
        if (-1 === u.outputLen) {
      ...
      for (i = this.R(this.Y.slice(), this.H, this.I, this.p(this.U), o), n = 1; n < this.numRounds; n += 1) {
        this.F && o % 32 != 0 && (i[i.length - 1] &= 16777215 >>> 24 - o % 32), i = this.R(i, o, 0, this.l(this.g), o);
      }
      return s(i);
      ...
      for (n < t.binLen / 8 && (t.value = this.R(t.value, t.binLen, 0, this.l(this.g), this.m)); t.value.length <= i;) {
        t.value.push(0);
      }
      for (r = 0; r <= i; r += 1) {
        this.L[r] = 909522486 ^ t.value[r], this.N[r] = 1549556828 ^ t.value[r];
      }
 ...
 * @param {string} inputString - The input string.
 * @param {string} type - The output type (e.g., HEX, B64).
